...
window.addEventListener('load', async () => {
  ...
  currentUserData.userId = dbUserData.userId;
...
clearImgBtn.addEventListener("click", () => {
  ...
  mockupAvatar.src = '/public/images/icons/icon-upload-image.svg';
  ...
  // console.log(`User avatar after deleting: ${JSON.stringify(currentUserData.avatar, null, 2)}`);
  checkDifferences();
});
...
/**
 * Adds new <li> element to <ul class="user-links">
 * @param {Link} link
 */
...
/**
 * Adds new <div class="phone-mockup-badge"> element to <div class="phone-mockup">
 * @param {Link} link
 */
function addNewMockupBadge (link) {
